...
export default function STBDetails() {
      ...
      <div className={`${Toggle ? "w-full transition-all" : "w-[85%] transition-all"}`}>
        ...
        <div className='text-sm text-white flex justify-end'>
          <div className='space-x-2'>
              <button className='button-input bg-teal-500'>Import STB Info</button>
              <button className='button-input bg-teal-500'>Export STB Info</button>
              <button className='button-input bg-teal-500'>Import State/City</button>
              <button className='button-input bg-teal-500'>Download Sample State/City XLS</button>
              <button className='button-input bg-teal-500'>Download Sample STB XLS</button>
              <button className='button-input bg-teal-500'>Add STB</button>
          </div>
        </div>
              ...
              <table className='w-full h-full table-auto rounded-sm shadow-md bg-white'>
                  <thead className='sticky top-0 uppercase text-xs text-md text-slate-600 bg-gray-200'>
                      <tr>
                          ...
                          <th className='py-2 px-3 whitespace-nowrap'><div className='flex justify-center items-center space-x-1'><p>BoxElapsedTime</p><BiSortUp></BiSortUp></div></th>
                          <th className='py-2 px-3 whitespace-nowrap'><div className='flex justify-center items-center space-x-1'><p>Last Updated Time</p><BiSortUp></BiSortUp></div></th>
