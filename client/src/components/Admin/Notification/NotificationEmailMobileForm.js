...
export default function NotificationEmailMobileForm() {
  return (
   ...
   <button className='button-input text-white text-sm bg-teal-500'>Save</button>
   </div>
