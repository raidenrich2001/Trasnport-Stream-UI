...
export default function SelectedFrequency() {
    return (
        <div className='border p-4'>
            <div className='flex justify-between'>
                <h1 className='font-semibold'>Monitor Config - Selected Frequency</h1>
            ...
            <p className='text-sm mt-2'>By configuring this option the Client is instructed to monitor only those selected frequencies one by one for the configured duration and update the report to the Server immediately.</p>
